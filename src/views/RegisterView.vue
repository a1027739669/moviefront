...
<!--            <captcha></captcha>-->
          ...
          <div v-if="activeStep === 1" class="register-step-two">
            ...
            <mu-text-field v-model.trim="username" :errorText="usernameError" label="昵称" hintText="请输入你的昵称" type="text" fullWidth icon="person" labelFloat/><br/>
            ...
            <div class="verification-area">
              <div class="verification-input">
                <mu-text-field v-model.trim="verification" :errorText="verificationError" label="验证码" hintText="请输入验证码" @textOverflow="handleVerificationOverflow" type="text" :maxLength="6" icon="sms" fullWidth labelFloat/><br/>
              </div>
